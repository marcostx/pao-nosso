...
class Solicitacao(db.Model):
    ...
    def to_dict(self):
        ...
        return {
            ...
            "data_coleta_proposta": (
                self.data_coleta_proposta.isoformat() if self.data_coleta_proposta else None
            ),
            "hora_coleta_proposta": (
                self.hora_coleta_proposta.isoformat() if self.hora_coleta_proposta else None
            ),
